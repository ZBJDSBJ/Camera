...
//            CamParaUtil.getInstance().printSupportPreviewSize(mParams);
            ...
            Size pictureSize = CamParaUtil.getInstance().getPropPictureSize(mParams);
            mParams.setPictureSize(pictureSize.width, pictureSize.height);

            Size previewSize = CamParaUtil.getInstance().getPropPreviewSize(mParams);
