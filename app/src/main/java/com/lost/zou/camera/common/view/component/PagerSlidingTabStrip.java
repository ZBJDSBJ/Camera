...
package com.lost.zou.camera.common.view.component;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = 0xFF222222;
    private int selectedTabTextColor = 0xff2da4f0;
    ...
    private PageSlidingStateListener viewpagerStateListener;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft, height - indicatorHeight
                + underLineMarginBottom, lineRight, height
    ...
    public void setViewPagerStateListener(PageSlidingStateListener viewpagerStateListener) {
