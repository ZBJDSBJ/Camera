...
public class CrashReport implements OnSharedPreferenceChangeListener {
    ...
    public void start(Context context) {
        ...
        if (ableAcra) {
            ...
            Loger.d(LOG_TAG, "ACRA is disabled for " + mContext.getPackageName() + ".");
            return;
        }
    }
    ...
    private void initAcra() {
        Loger.d(LOG_TAG, "ACRA is enabled for " + mContext.getPackageName() + ", intializing...");
        ...
        errorReporter.init(mContext.getApplicationContext());
    ...
    public Bundle getCrashResources() {
        ...
        result.putInt(RES_NOTIF_TITLE, R.string.crash_dialog_title);
